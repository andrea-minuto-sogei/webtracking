...
struct header_table_s
{
   const char *name;
   const char *pattern;
   ap_regex_t *regex;
   struct header_table_s *next;
};

typedef struct header_table_s header_table_t;
...
struct wt_config_s 
{
   ...
   header_table_t *exclude_response_header_table;
...
static header_table_t *add_header_entry(apr_pool_t *, header_table_t *, const char *, const char *, ap_regex_t *);
static void print_header_table(server_rec *, header_table_t *, const char *);
